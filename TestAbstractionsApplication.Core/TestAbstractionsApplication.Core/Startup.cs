using TestAbstractionsApplication.Common.Controllers;
using TestAbstractionsApplication.Common.Implementations;
using TestAbstractionsApplication.Common.Interfaces;

namespace TestAbstractionsApplication.Core
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllers()
                .AddApplicationPart(typeof(TestAbstractionsContoller).Assembly);
        }
